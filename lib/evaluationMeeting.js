...
class evaluationMeetingTransfer extends Contract {
    ...
    async CreateEvaluationMeeting(ctx, id, tender, secretary, meetingDate, members, present, video, minutes, report, documents, currentstate) {
        const evaluationMeeting = {
            ID: id,
            Tender: tender,
            Secretary: secretary,
    ...
    async UpdateEvaluationMeeting(ctx, id, tender, secretary, meetingDate, members, present, video, minutes, report, documents, currentstate) {
